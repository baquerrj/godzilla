...
| SYS-004        | Timestamps | The application shall ensure that all records, transaction, security, and audit log entries are timestamped with both a UTC and a local timestamp. | Review all log entries and databases and confirm that both timestamps are present.                   | |                                                 |
