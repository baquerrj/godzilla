...
| requirement ID | requirement title    | requirement body (including "shall" statements)                                                                                                                   | verification plan                                                                 | unit test                                        | parent requirement ID (if it is a derived requirement) |
| -------------- | -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------ | ------------------------------------------------------ |
| SEC-DATA-001   | No secrets in client | The system shall not embed Plaid client_secret or other provider secrets in any client-distributed artifact.                                                      | Binary/string scan and code review; validate secrets only on server side.         | | SYS-003                                                |
