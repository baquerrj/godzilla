 ...
 * REQ: TECH-SEC-ACC-001, TECH-SEC-ACC-002, TECH-SEC-ACC-003, TECH-SEC-ACC-004, TECH-SEC-NET-001
 */
...
function shouldUseTauriTransport(): boolean {
  // REQ: TECH-SEC-NET-001 — Tauri runtime enforces pinned local TLS through backend proxy command.
